...
class AccountTypesControllerTest < ActionController::TestCase
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post :create, account_type: { description: @account_type.description, max_expiry: @account_type.max_expiry, name: @account_type.name }
    end
  ...
  test "should update account_type" do
    patch :update, id: @account_type, account_type: { description: @account_type.description, max_expiry: @account_type.max_expiry, name: @account_type.name }
    assert_redirected_to account_type_path(assigns(:account_type))
  end
